// We use the spiderable package to make the page indexable with Meteor. Due to
// an unknown Apperin error, this if-test is a workaround to ignore the script
// in this file. It is only (?) the spiderable package that uses the PhantomJS
// browser, which is why we check for is as the userAgent.
